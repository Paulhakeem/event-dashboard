  ...
  <div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 px-4 py-10 sm:px-6 lg:px-8 lg:py-14">
    <div class="max-w-7xl mx-auto">
      ...
      <div class="mb-12 text-center">
        <h2 class="text-4xl font-bold text-gray-900 mb-3">Upcoming Events</h2>
        <p class="text-gray-600 text-lg">Discover and book amazing events happening near you</p>
      </div>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        >
          <NuxtLink :to="`/events/${event._id}`" class="block h-full">
            <!-- Image Container -->
            <div class="relative h-64 overflow-hidden">
              ...
              <div class="absolute top-4 left-4">
                <span class="bg-[#9c4e8b]/90 px-3 py-1 rounded-full text-white text-xs font-semibold backdrop-blur-sm">
            ...
            <div class="p-6">
              <!-- Title -->
              <h3 class="text-xl font-bold text-gray-900 group-hover:text-[#9c4e8b] transition mb-2 line-clamp-2">
                {{ event.title }}
              </h3>
              ...
              <div class="grid grid-cols-3 gap-2 mb-4">
                ...
                <div class="text-center p-2 bg-purple-50 rounded-lg hover:bg-purple-100 transition">
                  ...
                  <p class="text-sm font-bold text-gray-900">Ksh {{ event.vip }}</p>
                </div>
                <div class="text-center p-2 bg-purple-50 rounded-lg hover:bg-purple-100 transition">
                  <p class="text-xs font-semibold text-[#9c4e8b]">VVIP</p>
                  <p class="text-sm font-bold text-gray-900">Ksh {{ event.vvip }}</p>
                </div>
              </div>
      ...
      <!-- Empty State -->
      <div v-if="events.length === 0 && !pendings" class="text-center py-12">
